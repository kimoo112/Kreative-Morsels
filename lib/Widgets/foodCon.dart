...
class ContainerBD extends StatefulWidget {
  const ContainerBD({Key? key, this.image, this.text, this.recipe})
      : super(key: key);
  final image;
  final text;
  final recipe;
  ...
  @override
  _ContainerBDState createState() => _ContainerBDState();
}

class _ContainerBDState extends State<ContainerBD> {
